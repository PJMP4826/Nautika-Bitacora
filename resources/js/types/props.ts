...
export type ViewType = 'home' | 'zones' | 'fish' | 'types' | 'guides' | 'contact' | 'results' | 'zone-detail' | 'fish-detail' | 'not-found' | 'server-error' | 'maintenance';
...
export interface FishDetailViewProps {
    fish: FishType;
    onBack?: () => void;
